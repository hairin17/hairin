...
% input: loooverlap total matrix of shen 227
% output:  # of edges by each network, Matrix figure

function [shenmat] = shensoc227_matplot(overlap)

shennet = [9,9,9,2,9,3,2,2,2,9,4,1,3,2,4,9,2,4,9,4,2,2,5,5,5,5,5,4,4,2,2,4,5,5,5,4,5,5,5,5,8,6,8,4,5,5,2,9,9,3,5,1,1,1,9,1,1,5,8,5,5,5,5,9,9,8,8,6,8,2,8,6,8,8,6,7,6,7,6,6,7,6,4,5,3,3,6,4,5,9,4,5,4,4,4,3,5,6,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,3,4,4,9,9,2,9,3,2,2,4,9,4,2,9,1,1,1,4,1,2,4,1,2,5,5,5,5,1,5,2,1,5,5,5,4,5,5,5,5,5,8,6,8,4,5,5,5,2,9,2,9,1,9,5,5,9,5,1,2,1,5,2,5,6,2,8,8,5,3,8,6,8,6,6,8,8,6,7,7,7,6,6,4,5,1,4,4,9,3,4,9,4,3,5,4,4,9,4,4,4,5,4,4,4,4,4,4,4,4,4,4,4,4];
